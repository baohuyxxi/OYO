...
export default function RoomDetail() {
  ...
  const listConvenientData = [
    {
      name: "Máy lạnh",
      icon: "https://img.icons8.com/ios-filled/50/22C3E6/wardrobe--v1.png", // Đường dẫn đến biểu tượng máy lạnh (nếu có)
              ...
              <div className="col l-8 m-7 c-12">
                <div className="paper title-room">
                  <div className="desc-room">
                    ...
                    <p>
                      Là một lựa chọn đúng đắn khi quý khách đến thăm Thắng Tam.
                      Quầy tiếp tân 24 giờ luôn sẵn sàng phục vụ quý khách từ
                      thủ tục nhận phòng đến trả phòng
                    </p>
                  </div>
