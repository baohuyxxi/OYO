    ...
    return (
        <div>
            <div className={`border rounded-4 ${style.room_dropdown_container}`}>
                <div className="d-flex flex-row align-items-center" onClick={() => setOpenRooms((status) => !status)}>
                    <PersonIcon className="mt-1" />
                    <div className="d-flex ms-2 mt-1 flex-column">
                        <small style={{ fontSize: '9px' }} className="text-muted fw-lighter">
                            Persons and Rooms
                        </small>
                        <span style={{ fontSize: '13px' }} className="text-muted fw-lighter ">
                            2 Persons,1 Rooms
                        </span>
                    </div>
                    {openRooms ? (
                ...
                {openRooms && (
                    <>
                        <div className={`rounded-2 my-2 card shadow-lg ${style.Modal} ${style.room_element}`}>
                            <div className="row">
                                    ...
                                    <div className="d-flex flex-row p-1 justify-content-between">
                                        ...
                                        <div className="">
                                            <div className={style.optionCounter}>
                                                ...
                                                <span className={style.optionCounterNumber}>{option.adult}</span>
                                                <button
                                                    className={`btn btn-primary d-flex justify-content-center align-items-center ${style.optionCounterButton}`}
                                    ...
                                    <div className="d-flex flex-row p-1 justify-content-between">
                                        ...
                                        <div className="">
                                            <div className={style.optionCounter}>
                                                ...
                                                <span className={style.optionCounterNumber}>{option.children}</span>
                                                <button
                                                    className={`btn btn-primary d-flex justify-content-center align-items-center ${style.optionCounterButton}`}
                                    ...
                                    <div className="d-flex flex-row p-1 justify-content-between">
                                        ...
                                        <div className="">
                                            <div className={style.optionCounter}>
                                                ...
                                                <span className={style.optionCounterNumber}>{option.singleRoom}</span>
                                                <button
                                                    className={`btn btn-primary d-flex justify-content-center align-items-center ${style.optionCounterButton}`}
                                    ...
                                    <div className="d-flex flex-row p-1 justify-content-between">
                                        ...
                                        <div className="">
                                            <div className={style.optionCounter}>
                                                ...
                                                <span className={style.optionCounterNumber}>{option.twinRoom}</span>
                                                <button
                                                    className={`btn btn-primary d-flex justify-content-center align-items-center ${style.optionCounterButton}`}
                                    ...
                                    <div className="d-flex flex-row p-1 justify-content-between">
                                        ...
                                        <div className="">
                                            <div className={style.optionCounter}>
                                                ...
                                                <span className={style.optionCounterNumber}>{option.familyRoom}</span>
                                                <button
                                                    className={`btn btn-primary d-flex justify-content-center align-items-center ${style.optionCounterButton}`}
